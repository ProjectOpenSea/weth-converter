...
import {OrderParameters, OrderComponents, Order, BasicOrderParameters, SpentItem, AdditionalRecipient, OfferItem, ConsiderationItem, Fulfillment, FulfillmentComponent, AdvancedOrder} from "seaport-types/lib/ConsiderationStructs.sol";
...
contract OrderBuilder is OfferConsiderationItemAdder {
    ...
    function _configureOrderParameters(
        ...
        bytes32 conduitKey = useConduit ? conduitKey : bytes32(0);
        baseOrderParameters.offerer = offerer;
